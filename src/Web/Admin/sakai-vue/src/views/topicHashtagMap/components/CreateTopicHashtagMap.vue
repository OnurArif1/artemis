    ...
    <div>
        <form @submit.prevent="submit" class="card p-4">
            <div class="flex flex-col gap-2 mb-3">
                ...
                <Dropdown id="topicId" v-model="form.topicId" :options="topicOptions" optionLabel="label" optionValue="value" placeholder="Select Topic" :loading="topicLoading" filter class="w-full" />
                <Message v-if="form.topicId === null || form.topicId === undefined || form.topicId <= 0" size="small" severity="error" variant="simple"> Topic is required. </Message>
            </div>
