...
<template>
    <div class="select-purposes-page">
            ...
            <div class="main-card">
                ...
                <div class="card-header">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h1 class="card-title">Seni buraya getiren ne?</h1>
                            <p class="card-subtitle">Adım 3 / 3</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="content-area">
                    ...
                    <div class="purposes-list">
                        <label
                            ...
                            :class="[
                                'purpose-item',
                                isSelected(purpose.id) ? 'purpose-selected' : 'purpose-default'
                            ]"
                        >
                            <input
                                type="checkbox"
                            ...
                            <i
                                ...
                                class="pi pi-check-circle purpose-check-icon"
                            ></i>
                        </label>
                    </div>
...
.purpose-selected {
    ...
    border-color: #6300FF;
    box-shadow: 0 4px 12px rgba(99, 0, 255, 0.15);
}
